      ...
      @endif
        <div class="card mb-4">
            <div class="card-header d-flex pb-0">
              <h6>Sp table</h6>
              @if (Auth::user() && auth()->user()->id_role == '2')
              <a href="/sp/create" class="d-relative ms-auto btn btn-outline-primary btn-sm">Tambah</a>
              @endif
            </div>
            <div class="card-body ">
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <a href="{{ route('sp.delete', ['sp' => $item->id]) }}"><i class='bx bx-sm bx-trash text-danger'></i></a> --}}
