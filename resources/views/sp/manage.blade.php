                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="id_kelas" id="" class="form-control kelas-selects">
                                ...
                                <option value="{{ $item->id }}" {{ old('id_kelas', @$item->id == @$data->id_kelas ? 'selected' : '')}}>{{ $item->kode_kelas }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div id="id-mahasiswa">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="id_user_penerima" id="id_mahasiswa" class="form-control">
                                </select>
                            </div>
                        </div>
                    </div>
