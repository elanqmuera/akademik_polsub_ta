...
Route::group(['middleware' => 'auth.parent'], function(){
    ...
    Route::group(['prefix' => 'rekap-kehadiran'], function() {
    ...
    Route::group(['prefix'=>'perwalian'], function() {
        Route::get('/{kelas}',[PerwalianController::class, 'show'])->name('perwalian.show');
        Route::get('/{kelas}/{mahasiswa}/show',[PerwalianController::class, 'showNew'])->name('perwalian.showNew');
        Route::get('create/{kelas}', [PerwalianController::class, 'create'])->name('perwalian.create');
        Route::post('/{kelas}/store',[PerwalianController::class, 'store'])->name('perwalian.store');
        Route::get('/{kelas}/edit/{perwalian}', [PerwalianController::class, 'edit'])->name('perwalian.edit');
        Route::post('/{kelas}/update/{perwalian}', [PerwalianController::class, 'update'])->name('perwalian.update');
    });
